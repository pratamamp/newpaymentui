...
function Certificate({ username, email, licenseDate, persilID, orderID }) {
  ...
  return (
    <div className="w-11/12 h-[calc(100vh_-_15rem)] max-w-3xl bg-gradient-to-br from-white to-gray-100 rounded-xl relative overflow-clip shadow-white drop-shadow-lg blur-md md:filter-none">
      ...
      <div className="flex justify-center items-center w-full h-full select-none">
        <div className="border-2 border-yellow-400 w-[97%] h-[97%] rounded-xl flex flex-col">
          <div className="w-full mx-8 mt-4 border-b-[2px] border-slate-400">
            <p className="text-[#cd526a] font-bold text-lg tracking-widest">
              VERIFICATION OF LAND BUYING
            </p>
          </div>
          ...
          <div className="z-10">
            <h1 className="text-8xl mt-8 font-windsong mx-8 font-semibold text-[#d25eac]">
              {username}
            </h1>

            <h2 className="mx-8 text-sm mt-16">
          ...
          <div className="mt-auto mx-8 my-3 justify-around">
